...
<html lang="en">
    <head>
        ...
        <title>Benguet: Printed ePhilID Search</title>
        ...
        <section>
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-6">
                        <h1 class="mt-5">Personal Information:</h1>
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        function search_csv($file, $search_value, $search_value2, $search_value3) {
                            ...
                            foreach ($rows as $row) {
                                if (strtolower($row[0]) == strtolower($search_value) || 
                                    ...
                                    strtolower($row[0]) == strtolower($search_value3)) { //check if the first column of the row matches the first search_value
                                    ...
                                    if (strtolower($row[1]) == strtolower($search_value) || 
                                        ...
                                        strtolower($row[1]) == strtolower($search_value3)) { //if the first column of the row matched a value, proceed to second column of the row
                                        ...
                                        if (strtolower($row[2]) == strtolower($search_value) || 
                                            ...
                                            strtolower($row[2]) == strtolower($search_value3)) { //if the first and second column of the row matched a value, check the last one
                                            //echo "Matching value found in column 2: " . $row[2];
                                            echo '<p><i class="fa-regular fa-address-card" style="font-size:50px"></i> <i class="fa-regular fa-square-check" style="font-size:50px"></i></p>';
                            ...
                            if(!$match_found) {
                                echo '<p><i class="fa-regular fa-address-card" style="font-size:50px"></i> <i class="fa-regular fa-circle-xmark" style="font-size:50px"></i></p>';
                        ...
                        switch ($search_area){
                            ...
                            case "TUBLAY":
                                ...
                                break;
                            default:
                                echo '<p><i class="fa-regular fa-address-card" style="font-size:50px"></i> <i class="fa-solid fa-triangle-exclamation" style="font-size:50px"></i></p>';
                                echo '<p><code>Please select correct city/municipality. Thank you.</code></p>';
                        }
                    }
                    ?>
                <p style="font-size:9px"><i><mark><i class="fa-solid fa-triangle-exclamation"></i> Disclaimer: Empty or "No Search Results" means your printed ePhilID is <u>"not yet available or may have been dispatched last 2022"</u>.</mark></i></p>
                <p style="font-size:9px"><i><mark><i class="fa-regular fa-lightbulb"></i> Advice: Try selecting your secondary municipality registered in Step 2 <u>as it may yield a different result</u>.</mark></i></p>
                </div>
            </div>
        </section>
        <!-- Bootstrap core JS-->
