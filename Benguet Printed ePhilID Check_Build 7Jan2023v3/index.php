    ...
    <body>
        ...
        <div id="myModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">DATA PRIVACY</h5>
                </div>
        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    <p class="mb-1" style="font-size:small">Page visits <span class="badge bg-secondary"> 
                    <?php
                    ...
                    <h1 class="fst-italic lh-1 mb-1" style="font-size:40px">Printed ePhilID Search</h1>
                    <p class="mb-1" style="font-size:small">Enter your details to identify if your <u>printed ePhilID</u> is available.</p>
                    <hr>
                    <!-- * * * * * * * * * * * * * * *-->
                    ...
                    <form method="POST" action="search.php">
                        <div class="mb-2">
                          ...
                          <input type="text" class="form-control" id="InputLastname" name="lastname_php" placeholder="" style="text-transform:uppercase"; autocomplete="off">
                        </div>
                        <div class="mb-2">
                            <label for="InputFirstname" class="form-label">First Name/s</label>
                            <input type="text" class="form-control" id="InputFirstname" name="firstname_php" placeholder="" style="text-transform:uppercase"; autocomplete="off" required>
                        </div>
                        <div class="mb-2">
                            <label for="InputMiddlename" class="form-label">Middle Name</label>
                            <input type="text" class="form-control" id="InputMiddlename" name="middlename_php" placeholder="" style="text-transform:uppercase"; autocomplete="off">
                        </div>
                        <div class="mb-3">
                            <label for="InputSuffix" class="form-label">Suffix</label>
                            <input type="text" class="form-control" id="InputSuffix" name="suffix_php" placeholder="" style="text-transform:uppercase"; autocomplete="off">
                        </div>

                        <!-- Dropdown for City/Municipality --> 
                        <div class="mb-2">
                            <label for="firstDropdown" class="form-label">City/Municipality</label>
                            <select id="firstDropdown" name="area_php">
                       ...
                       <!-- Dropdown for Barangay -->
                        ...
                        <button type="submit" class="btn btn-primary" id="myBtn" name="search">Search</button>
                      </form>
        ...
        <div class="social-icons">
            <div class="d-flex flex-row flex-lg-column justify-content-center align-items-center h-100 mt-3 mt-lg-0">
                ...
                <a class="btn btn-dark m-3" href="https://www.privacy.gov.ph/data-privacy-act/" target="_blank" title="Data Privacy Act of 2012"><i class="fa-solid fa-shield-halved"></i></a>
            </div>
        </div>
