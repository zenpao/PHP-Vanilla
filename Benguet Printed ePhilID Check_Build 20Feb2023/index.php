    ...
    <body>
        ...
        <div class="offcanvas-body">
            ...
            <hr>
                ...
                <img src="static/assets/img/disclaimer.jpg" width="130" height="130" alt="" class="d-inline-block align-center">
                </blockquote>
                <figcaption class="blockquote-footer" style="font-size:9.5px;">
                <You class="text-justify"><strong>Disclaimers:</strong> "No Results or ❌" means your printed ePhilID is <u>"not yet available or may have been dispatched last 2022"</u>. Try using the details reflected on TRN Slip or secondary municipality in Step 2 Registration. You may present your TRN Slip and visit the nearest Registration Center in your area for inquiries.</p>
                </figcaption>
                </figure>
