        ...
        <div class="offcanvas-body">
            ...
            <?php
                ...
                if (isset($_POST['check'])) {
                    ...
                    echo '<h5 class="offcanvas-title" id="offcanvasExampleLabel"><i class="fa-solid fa-magnifying-glass"></i> See result below for: <br><u>';
            ...
            <hr>
                ...
                <figcaption class="blockquote-footer" style="font-size:10px;">
                <img src="static/assets/img/strange.gif" width="40" height="40" alt="" class="d-inline-block align-center"> Disclaimer: "No Search Results or ❌" means your printed ePhilID is <u>"not yet available or may have been dispatched last 2022"</u>. Try using the details reflected on TRN Slip or secondary municipality in Step 2 Registration <u>as it may yield a checked result</u> ✔️. You may present your TRN Slip and visit the nearest Registration Center in your area for inquiries and assistance.</i>
                </figcaption>
                </figure>
