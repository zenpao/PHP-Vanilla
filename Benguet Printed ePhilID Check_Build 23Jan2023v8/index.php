...
<html lang="en">
    ...
    <body>
        ...
        <div class="offcanvas offcanvas-bottom show" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header">
            <small class="offcanvas-title" id="offcanvasExampleLabel"><img src="static/assets/img/favicon.ico" width="30" height="30" alt="" class="d-inline-block align-center">
                <?php
        ...
        <div class="offcanvas-body">
            ...
            <?php
                ...
                if (isset($_POST['check'])) {
                    ...
                    echo '<h5 class="offcanvas-title" id="offcanvasExampleLabel"><i class="fa-solid fa-magnifying-glass"></i> SEARCH RESULT: ';
                    ...
                    switch ($search_area){
                        ...
                        default:
                            ...
                            echo "<p>$message_invalid</p>";
                    }
                }
            ?>
                <p style="font-size:12px;"><i class="fa-solid fa-triangle-exclamation" style="color: red"></i><i> Disclaimer: Empty or "No Search Results" means your printed ePhilID is <u>"not yet available or may have been dispatched last 2022"</u>. Try using the name reflected on TRN Slip or secondary municipality registered in Step 2 <u>as it may yield different results</u>. You may present your TRN Slip and visit the nearest Registration Center in your area for inquiries.</i></p>
            <hr>
                <!-- <button type="button" class="btn btn-primary btn-sm" onclick="window.print();return false;">Save</button> -->
            </div>
        </div>
        </div>
